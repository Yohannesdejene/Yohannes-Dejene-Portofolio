    ...
    <main className="flex flex-col min-h-[100dvh]">
      ...
      <section id="projects" className="pt-6">
        <div className="space-y-8 w-full">
          <BlurFade delay={BLUR_FADE_DELAY * 11}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="mt-6 text-xl font-bold tracking-tighter sm:text-3xl">
          ...
          <h2 className=" text-center text-md md:text-xl font-bold tracking-tighter ">
            Company projects{" "}
          </h2>
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 max-w-[800px] mx-auto">
            {DATA.personalProjects.map((project: any, id: number) => (
              <BlurFade
                key={project.title}
                delay={BLUR_FADE_DELAY * 12 + id * 0.05}
              >
